 ...
 */
export const getUpdateMyUsernameUrl = () => {
...
export const updateMyUsername = async (
  ...
  return customFetch<User>(getUpdateMyUsernameUrl(), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getUpdateMyUsernameMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateMyUsername>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["updateMyUsername"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updateMyUsername(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdateMyUsernameMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateMyUsername>>
>;
export type UpdateMyUsernameMutationBody = BodyType<UsernameUpdate>;
export type UpdateMyUsernameMutationError = ErrorType<ErrorResponse>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getUpdateMyUsernameMutationOptions(options));
};
